/* ═══════════════════════════════════════════════════════════════
   CASONA BELGA - AI-POWERED CHATBOT (ESPAÑOL)
   Chat con Inteligencia Artificial usando Google Gemini
   ═══════════════════════════════════════════════════════════════ */
      ...
      <div id="casona-chat-window" class="chat-window">
        <div class="chat-header">
          <div class="chat-header-content">
            ...
            <div>
              <div class="chat-title">Asistente Casona Belga</div>
              <div class="chat-status">Con Inteligencia Artificial</div>
            </div>
          </div>
        ...
        <div class="chat-body" id="casona-chat-body">
          <div class="chat-message bot-message">
            <div class="message-bubble">
              ¡Hola! 👋 Soy tu asistente virtual con Inteligencia Artificial.<br><br>
              Puedo ayudarte con información sobre:<br>
              • Menú y platos (incluyendo opciones veganas)<br>
              • Habitaciones y reservas<br>
              • Actividades en Chile Chico<br>
              • Horarios y ubicación<br><br>
          ...
          <div class="chat-quick-buttons">
            ...
            <button class="quick-btn" data-question="Información de habitaciones">🛏️ Habitaciones</button>
            <button class="quick-btn" data-question="¿Qué actividades hay en Chile Chico?">🏔️ Actividades</button>
            <button class="quick-btn" data-question="¿Cuáles son los horarios?">⏰ Horarios</button>
          </div>
        </div>
  ...
  async callAI(message) {
    ...
    try {
      ...
      if (error.message.includes('Failed to fetch')) {
        throw new Error('No se puede conectar con el servidor. Por favor, verifica que el backend esté corriendo.');
      }
    ...
    const errorMessage = `
      <div class="chat-message bot-message">
        <div class="message-bubble" style="background: linear-gradient(135deg, rgba(211, 47, 47, 0.2), rgba(198, 40, 40, 0.1)); border-color: rgba(211, 47, 47, 0.4);">
          ...
          Por favor, intenta de nuevo o contacta directamente por WhatsApp.
          <div class="message-actions">
            <a href="https://wa.me/message/TSCZUHZY7LTVJ1"
               class="message-action-btn primary"
               target="_blank"
